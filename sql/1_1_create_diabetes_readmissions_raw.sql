...
DROP TABLE diabetes_readmissions;
...
-- Rename column to avoid reserved-word ambiguity 
ALTER TABLE diabetes_readmissions
RENAME COLUMN change TO medication_change;